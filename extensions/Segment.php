...
class Segment {
	...
	function segment($str){
		include_once APP_PATH.'/extensions/segment/pscws4.class.php';
		$cws = new PSCWS4();
		$cws->set_charset('utf8');
		$cws->set_dict(APP_PATH.'/extensions/segment/etc/dict.utf8.xdb');
		$cws->set_rule(APP_PATH.'/extensions/segment/etc/rules.utf8.ini');
		$cws->set_ignore(true);
		$cws->set_multi(1);
